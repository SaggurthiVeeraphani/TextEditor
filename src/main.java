...
class editor extends JFrame implements ActionListener {
    ...
    editor()
    {
     ...
     // create action listeners to the menu bar
    ...
    public void actionPerformed(ActionEvent e){
        ...
        // create if else condition statement for each case
        if(s.equals("cut")){
            t.cut();
        }
            ...
            if(r==JFileChooser.APPROVE_OPTION){
                ...
                JOptionPane.showMessageDialog(f,"User has cancelled Operation");
            }
